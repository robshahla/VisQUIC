event_type = [
    ...
    "QUIC_STREAM_FACTORY_PLATFORM_NOTIFICATION",   
    "QUIC_STREAM_FACTORY_ON_IP_ADDRESS_CHANGED",
    "QUIC_STREAM_FACTORY_CLOSE_ALL_SESSIONS",
    "QUIC_STREAM_FACTORY_MARK_ALL_ACTIVE_SESSIONS_GOING_AWAY",             
